        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    dataaaa = self.chrome.find_element_by_css_selector('#dataNascimento').send_keys(data)
                    sleep(0.5)
                    nomee = self.chrome.find_element_by_id('#nomeCliente').click()
                    nomee = self.chrome.find_element_by_css_selector('#nomeCliente').send_keys(nome)
                    pyautogui.click(x=550, y=550)
                    sleep(3)
                    ...
                    sleep(2)
                    In = self.chrome.find_element_by_css_selector(
                        '#myTable > tbody > tr:nth-child(6) > td:nth-child(2)')
                    In.click()
...
################################################################################################################
            ...
            try:
                ...
                try:
                    ...
                    sleep(15)
                    try:
                        print('tenatando conectar de primeira no banco..')
                        bancoo = self.chrome.find_element_by_css_selector('#banco')
                        bancoo.click()
                        sleep(2)
                        facta = self.chrome.find_element_by_css_selector('#banco > option:nth-child(7)')
