...
class ChromeAuto:
    ...
    def proposta(self):
        ...
        try:
            ...
            sleep(1)
            filtro= self.chrome.find_element_by_css_selector('#filtro-paper > div > div:nth-child(3) > div.sc-jAaTju.fVRxI').click()
            sleep(5)
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            sleep(2)
                                            if tabela == 'DIG INSS - NOVO 2,14 / SEM CARENCIA 120 DIAS':
                                                In = self.chrome.find_element_by_xpath('//*[@id="myTable"]/tbody/tr[9]')
                                                In.click()
                                            if tabela == 'DIG INSS - NOVO 2,14 / COM CARENCIA 120 DIAS':
